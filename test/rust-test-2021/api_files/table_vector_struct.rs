...
check_type!(Example => create(&mut planus::Builder, planus::Offset<[Inner]>, planus::Offset<[Inner]>, planus::Offset<[Inner]>, planus::Offset<[Inner]>) : planus::Offset<Example>);
check_type!(Example => create(&mut planus::Builder, Option<planus::Offset<[Inner]>>, Option<planus::Offset<[Inner]>>, planus::Offset<[Inner]>, planus::Offset<[Inner]>) : planus::Offset<Example>);
...
check_type!(+['a] ExampleRef<'a> => &self.value() : planus::Result<Option<planus::Vector<'a, InnerRef<'a>>>>);
check_type!(+['a] ExampleRef<'a> => &self.value_null() : planus::Result<Option<planus::Vector<'a, InnerRef<'a>>>>);
check_type!(+['a] ExampleRef<'a> => &self.value_default_empty() : planus::Result<planus::Vector<'a, InnerRef<'a>>>);
check_type!(+['a] ExampleRef<'a> => &self.value_required() : planus::Result<planus::Vector<'a, InnerRef<'a>>>);
