...
check_type!(Example => create(&mut planus::Builder, planus::Offset<[planus::Offset<str>]>, planus::Offset<[planus::Offset<str>]>, planus::Offset<[planus::Offset<str>]>, planus::Offset<[planus::Offset<str>]>) : planus::Offset<Example>);
check_type!(Example => create(&mut planus::Builder, Option<planus::Offset<[planus::Offset<str>]>>, Option<planus::Offset<[planus::Offset<str>]>>, planus::Offset<[planus::Offset<str>]>, planus::Offset<[planus::Offset<str>]>) : planus::Offset<Example>);
