...
check_type!(+['a] Union => create_foo(&mut planus::Builder, &'a pstr) : planus::UnionOffset<Union>);
check_type!(+['a] Union => create_foo(&mut planus::Builder, &'a String) : planus::UnionOffset<Union>);
check_type!(+['a] Union => create_foo(&mut planus::Builder, &'a PString) : planus::UnionOffset<Union>);
check_type!(Union => create_foo(&mut planus::Builder, String) : planus::UnionOffset<Union>);
check_type!(Union => create_foo(&mut planus::Builder, PString) : planus::UnionOffset<Union>);
...
check_type!(Union => Foo(PString) : Union);
...
check_type!(+['a] UnionRef<'a> => Foo(&'a pstr) : UnionRef<'a>);
