...
check_type!(Example32 => create(&mut planus::Buffer, f32, f32, f32, f32) : planus::Offset<Example32>);
check_type!(Example32 => create(&mut planus::Buffer, f32, (), f32, f32) : planus::Offset<Example32>);
check_type!(Example32 => create(&mut planus::Buffer, f32, Option<f32>, f32, f32) : planus::Offset<Example32>);
...
check_type!(Example64 => create(&mut planus::Buffer, f64, f64, f64, f64) : planus::Offset<Example64>);
check_type!(Example64 => create(&mut planus::Buffer, f64, (), f64, f64) : planus::Offset<Example64>);
check_type!(Example64 => create(&mut planus::Buffer, f64, Option<f64>, f64, f64) : planus::Offset<Example64>);
