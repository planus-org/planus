...
check_type!(Example => create(&mut planus::Buffer, String, String, String, String, String) : planus::Offset<Example>);
check_type!(Example => create(&mut planus::Buffer, (), (), String, String, String) : planus::Offset<Example>);
check_type!(Example => create(&mut planus::Buffer, Option<String>, Option<String>, String, String, String) : planus::Offset<Example>);
check_type!(+['a, 'b, 'c, 'd, 'e] Example => create(&mut planus::Buffer, &'a str, &'b str, &'c str, &'d str, &'e str) : planus::Offset<Example>);
check_type!(+['a, 'b, 'c, 'd, 'e] Example => create(&mut planus::Buffer, Option<&'a str>, Option<&'b str>, &'c str, &'d str, &'e str) : planus::Offset<Example>);
